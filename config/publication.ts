...
export const publications: PublicationProps[] = [
  {
    year: 2026,
    title:
      'SpringFuzz: Comprehensive Grey-Box Fuzzing of Spring-Based Web Applications',
    authors: 'D Zou, J Tao, R Li, K Zhou, H Wu',
    source: 'Computers & Security',
    href: 'https://www.sciencedirect.com/science/article/pii/S0167404826000416',
    rank: 'B',
  },
  {
    year: 2025,
