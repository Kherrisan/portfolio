...
const Home = ({
  ...
  latestPrivatePost: LatestPostProps
}) => {
    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-6">
        <Image
          ...
          src={
            'https://npm.elemecdn.com/kendrickzou-portfolio-img@1.0.42-924cd7/d55cc4bef95b61b23cb27516b44bd99e@1x.jpeg'
          }
          alt="avatar"
          width={120}
          height={120}
        ...
        <div className="primary-text">
          <p className="mb-8 leading-7">Researcher / Developer </p>
          ...
          <p className="mb-8 leading-7">
            Recently, I have been researching automated vulnerability discovery,
            mainly through fuzzing, while actively embracing the changes brought
            by large language models and agents. You can view the CVEs I have
            discovered on the{' '}
            <Link
              className="group inline-flex flex-wrap items-center"
              href="/vulnerability"
            >
              <UnderlineLink>Vulnerability</UnderlineLink>
              <LinkArrowRight />
            </Link>{' '}
            page.
          </p>
